...
class ExpenseServices {
  ...
  downloadExcel(String sheetName, List<ExpenseModel> expenses) async {
    ...
    for (var expense = 0; expense < expenses.length; expense++) {
      sheet
          .cell(
              CellIndex.indexByColumnRow(columnIndex: 0, rowIndex: expense + 1))
          .value = expenses[expense].index;
      sheet
          .cell(
              CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: expense + 1))
          .value = expenses[expense].type;
      sheet
          .cell(
              CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: expense + 1))
          .value = expenses[expense].amount;
      sheet
          .cell(
              CellIndex.indexByColumnRow(columnIndex: 3, rowIndex: expense + 1))
